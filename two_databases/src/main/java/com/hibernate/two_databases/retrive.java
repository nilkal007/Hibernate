...
public class retrive {
	public static void main(String[] args) {
		 ...
		 * 
		 * Iterator<Entry<student, address>> mobemp = enum1.iterator(); while
		 * (mobemp.hasNext()) { session3.save(mobemp); Entry<student, address> entry =
		 * mobemp.next(); System.out.println(entry.getKey() + "............." +
		 * entry.getValue()); }
		 */
		session3.flush();
		tx3.commit();
