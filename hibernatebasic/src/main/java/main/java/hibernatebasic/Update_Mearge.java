...
public class Update_Mearge {
	...
	public static void main(String[] args) {
		...
		// Book b2=session2.get(Book.class, 2);//return -java.lang.NullPointerException
		...
		b2.setBk_nm("mint");
		// session2.update(b1);// org.hibernate.NonUniqueObjectException: A different
		// object with the same identifier value was already associated with the session
		// : [main.java.hibernatebasic.Book#1]
		session2.merge(b1);
